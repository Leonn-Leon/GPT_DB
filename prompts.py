...
Пользователь:
    ...
    "SQL": "select sum(ZAMARGPRF_RUB) as ZAMARGPRF_RUB from columnar.azsdm_1612",
    "Фильтры": ""
...
Пользователь:
    ...
    "SQL": "select VBRK_VBELN, VBRP_POSNR from columnar.azsdm_1612 where ZDIV='02' and ZDIV='03' ",
